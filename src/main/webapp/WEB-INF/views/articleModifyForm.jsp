...
<body>
	<div class="container p-0">
		<div class="boardTitle"><h1>MODIFY</h1></div>
		<div class="article p-0 m-0">
			<div class="contents p-0 m-0">
				<form action="articleModify" method="post" id="modifyForm">
					...
					<div class="row content col-12 p-0 m-0">
						...
						<div class="inputImage col-12 p-0">
							...
							<input type="hidden" name=image id="imageSrc" value="${dto.image }">
							<div id="imageBox" class="p-0"><img src="${dto.image }"></div>
						</div>
						<div class="inputContents col-12 p-0">
							<input type="hidden" id="submitContents" name="contents">
							<div id="contents" class="summernote" contenteditable="true">${dto.contents }</div>
						</div>
					</div>
	...
	<script>
		document.getElementById("writeBtn").onclick = function() {
			...
			if (title == "") {
				...
				alert("내용을 작성해주세요.");
			} else if (confirm("글 수정을 완료하시겠습니까?")) {
		...
		document.getElementById("cancelBtn").onclick = function() {
			...
			if (confirm("입력하신 내용이 사라집니다. 그래도 취소하시겠습니까?")) {
				location.href = "read?seq=${dto.seq}&currentPage=${currentPage}";
			}
		}
